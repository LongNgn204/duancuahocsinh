...
// Chú thích: Sleep Helper v1.0 - Âm thanh thư giãn và theo dõi giấc ngủ
...
import {
    ...
    CloudRain, Wind, Waves, Flame, Music, Bird, Timer
} from 'lucide-react';
                ...
                >
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold flex items-center gap-3">
                            ...
                            <span className="gradient-text">Sleep Helper</span>
                        </h1>
